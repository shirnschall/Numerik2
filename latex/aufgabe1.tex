...
\begin{document}
	...
	\newpage
	\footnotetext[1]{$A,B\in \mathbb{R}^{n\times n},b\in \mathbb{R}^n,c\in \mathbb{R},n\in\mathbb{N}$}
	\begin{figure}[H]
	\begin{subfigure}[t]{0.5\textwidth}
			\includegraphics[width=\linewidth]{../plots/precond-vs-cg.png}
		\subcaption{Koeffizientenmatrix der Form $A = B+B^T+c\cdot diag(b)$\footnotemark}
		\label{fig:precond-vs-cg}	
	\end{subfigure}
		\begin{subfigure}[t]{0.5\textwidth}
				\includegraphics[width=\linewidth]{../plots/precond-vs-cg-ndiag.png}
			\subcaption{Koeffizientenmatrix der Form $A = B+B^T+c\cdot I_n$}
