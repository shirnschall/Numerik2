...
\begin{document}
	...
	\lstinputlisting[label={lst:cg}, language=C++, firstline = 499, lastline= 548, caption = Implementierung des CG-Verfahrens in C++]{../code/Linag/densematrix.h} 
	...
	\lstinputlisting[label={lst:sparse-vektor-mult}, language=C++, firstline = 84, lastline= 95, caption = \"Uberladen der Matrix-Vektor Multiplikation f\"ur d\"unnbesetzte Matrizen]{../code/Linag/sparsematrix.h} 
