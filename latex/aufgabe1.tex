...
\begin{document}
	...
	\subsection{Size}
	\lstinputlisting[language=c,  caption=densematrix.h]{../code/Linag/size.h}
	\subsection{Vektor}
	\lstinputlisting[language=c,  caption=densematrix.h]{../code/Linag/vector.h}
	...
	\lstinputlisting[language=c,  caption=densematrix.h]{../code/Linag/sparsematrix.h}
